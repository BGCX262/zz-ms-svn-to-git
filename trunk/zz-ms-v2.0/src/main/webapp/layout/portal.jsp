...
<html>
  <head>
	...
	<script type="text/javascript" src="${ctx }/images/extend/jquery.portal.js"></script>
  	<link rel="stylesheet" href="${ctx }/images/extend/portal.css" type="text/css"></link>
	...
	$(function(){
		...
		$("#chartContainer").insertFusionCharts({
			swfUrl: "${ctx }/js/FusionCharts/Column2D.swf",
		...
		$("#chartContainer2").insertFusionCharts({
			swfUrl: "${ctx }/js/FusionCharts/MSColumn3D.swf",
			//dataSource: "js/FusionCharts/Data.xml",
			//dataFormat: "xmlurl",
			width: parseInt($(this).width()*0.5)-80,
			height: parseInt($(this).height()*0.4),
	...
	function openPDF(){
		window.open('${ctx}/a.pdf','打印标签','height=300,width=400,top=0,left=0,toolbar=yes,menubar=yes,scrollbars=no,resizable=yes,location=no,status=no');
	}
	</script>
  </head>
  <body>
