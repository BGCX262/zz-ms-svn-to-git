...
import com.zz.bsp.core.OecsUserDetailsImpl;
...
public class ModelUpdInfoUtils {
     ...
     * @param user 用户实体类
     */
    public static void updateModelInfo(Serializable object, OecsUserDetailsImpl user){
     ...
     * @param user 用户实体类
     */
     protected static void updateModelCreateInfo(Serializable object, OecsUserDetailsImpl user){
