 ...
 *
 */
public class OecsCriterion implements Serializable {
    ...
    public OecsCriterion(){

    }

    public OecsCriterion(List<PropertyFilter> criteria){
        this.criteria = criteria;
    }

    public OecsCriterion(List<PropertyFilter> criteria, String orderBy){
        this.criteria = criteria;
        this.orderBy = orderBy;
    }

    public OecsCriterion(List<PropertyFilter> criteria, String orderBy, String order){
        this.criteria = criteria;
        this.orderBy = orderBy;
        this.order = order;
    }
