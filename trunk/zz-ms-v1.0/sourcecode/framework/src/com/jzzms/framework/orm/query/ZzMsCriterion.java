...
package com.jzzms.framework.orm.query;
 ...
 * 
 */
public class ZzMsCriterion implements Serializable {
    ...
    public ZzMsCriterion(){
        
    }
    
    public ZzMsCriterion(List<PropertyFilter> criteria){
        this.criteria = criteria;
    }
    
    public ZzMsCriterion(List<PropertyFilter> criteria, String orderBy){
        this.criteria = criteria;
        this.orderBy = orderBy;
    }
    
    public ZzMsCriterion(List<PropertyFilter> criteria, String orderBy, String order){
        this.criteria = criteria;
        this.orderBy = orderBy;
        this.order = order;
    }
