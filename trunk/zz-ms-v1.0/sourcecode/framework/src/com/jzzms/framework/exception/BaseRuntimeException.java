...
public class BaseRuntimeException extends RuntimeException  {
    ...
    public BaseRuntimeException(String errMsg, String errCode, Throwable cause) {
    ...
    public BaseRuntimeException(String errCode, Throwable cause) {
        super(errCode, cause);
    ...
    public BaseRuntimeException(String errMsg, String errCode) {
    ...
    public BaseRuntimeException(Throwable cause) {
        ...
        else if(cause instanceof BaseAppException){
